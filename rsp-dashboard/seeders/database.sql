...
CREATE TABLE IF NOT EXISTS applicants (
    ...
    vacancyAnnouncementNo VARCHAR(100) DEFAULT NULL,
    status ENUM('PENDING', 'QUALIFIED', 'DISQUALIFIED', 'DISQUALIFIED_ARCHIVED', 'WAITING_FOR_ASSESSMENT', 'ASSESSED', 'NO_APPEARANCE', 'NEWLY_PROMOTED', 'WAITING', 'ASSIGNED', 'COMPLETED') DEFAULT 'PENDING',
...
CREATE TABLE IF NOT EXISTS applicant_email_logs (
    id INT AUTO_INCREMENT PRIMARY KEY,
    applicant_id INT NOT NULL,
    email_type VARCHAR(20) DEFAULT 'codes',
