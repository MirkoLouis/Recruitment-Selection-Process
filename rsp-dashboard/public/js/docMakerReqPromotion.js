window.printReqPromotion = async function(id) {
    ...
    const templateUrl = "/templates/Notice of Requirements - Promotion.docx";
    const filename = `Notice_of_Requirements_Promotion_${appName.replace(/[^a-zA-Z0-9]/g, '_')}.docx`;
    ...
    try {
        ...
        window.showToast('Notice of Requirements (Promotion) generated successfully.', 'success', true);
    } catch (e) {
